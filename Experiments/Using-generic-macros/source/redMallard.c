...
void
redMallardQuack( redMallard thisRedMallard )
{
    printf("\t%s: Quack!\n", duckGetName(thisRedMallard->parentMallard));
}

void
redMallardShow( redMallard thisRedMallard )
{
...
const char *
redMallardGetColor( redMallard thisRedMallard )
{
    return mallardGetColor( thisRedMallard->parentMallard );
}

void
redMallardMigrate( redMallard thisRedMallard )
{
    Mallard thisMallard = thisRedMallard->parentMallard;
